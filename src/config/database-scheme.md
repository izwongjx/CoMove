...
erDiagram
	...
	RIDE_REQUEST {
		...
		FLOAT amount_paid  "DERIVED: (TRIP.total_amount / TRIP.total_seats) * RIDE_REQUEST.seats_requested WHERE RIDE_REQUEST.trip_id = TRIP.trip_id"  
	...
	SYSTEM_CONFIG{
		BOOLEAN driver_registration ""
		BOOLEAN rider_registration ""
		BOOLEAN system_maintenance ""
	}
	...
	RIDER||--o{RIDER_GREEN_POINT_LOG:"earns/redeems"
	DRIVER||--o{DRIVER_GREEN_POINT_LOG:"earns/redeems"
